...
class ImagenProvider extends ChangeNotifier {
  ...
  getJsonData(String id) async {
    final url =
        Uri.https('api.thecatapi.com', "v1/images/$id", {'x-api-key': _api});
